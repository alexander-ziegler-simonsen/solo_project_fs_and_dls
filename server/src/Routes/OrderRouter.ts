...
OrderRouter.post("/order", async (req, res) => {
    ...
    let response = await rabbitHelper.handlePostToChannel("posts", "post", "order", req.body );
...
const rabbitHelper = new RabbitMQHelper();
    ...
    let response = await rabbitHelper.handlePostToChannel("updates", "put", "order", req.body );
...
const rabbitHelper = new RabbitMQHelper();
    ...
    let response = await rabbitHelper.handlePostToChannel("deletes", "delete", "order", req.body );
