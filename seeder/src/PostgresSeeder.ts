...
// we get all the merge data, which we need for the item documents on mongodb
export async function GetPostItems() {

    console.log("GetPostItems was called");
    ...
    try {
        const query = {
            ...
            , item."name" as "ItemName", item."price", item."description", item."image", item."fk_group_id", item."info",
            "itemgroup"."name" as "itemGroupName"
            FROM item
            INNER JOIN "public"."itemgroup" ON "public"."item"."fk_group_id" = "public"."itemgroup"."_id"
            ` };

        output = await poolClient.query(query);
        //console.log("we got output, here it is:", output);
        return output;

        // await poolClient.query("COMMIT");
    } catch (err) {
        console.error("GetPostItems error :", err);
    } finally {
        await poolClient.release();
        await poolClient.end();
    }
...
// we get all the merge data, which we need for the order documents on mongodb
export async function GetOrders() {
    ...
    try {
        const query = `
        SELECT
        "public"."order"."_id" as "order_id",
        "public"."order"."fk_user_id",
        
        "public"."user"."_id" as "user_id",
        ...
        "public"."orderitem"."count",
        "public"."orderitem"."fk_order_id",
        "public"."orderitem"."price" as "orderItem_price",
        "public"."orderitem"."fk_item_id",
        "public"."orderitem"."_id" as "orderItem_id",
        
        "public"."item"."_id" as "item_id",
        "public"."item"."name" as "item_name",
        "public"."item"."price" as "item_price",
        "public"."item"."info",
        "public"."item"."description",
        "public"."item"."image",
        "public"."item"."fk_group_id",
        
        "public"."itemgroup"."_id" as "itemGroup_id",
        "public"."itemgroup"."name" as "itemGroup_name"
        FROM
        "public"."item"
        INNER JOIN "public"."orderitem" ON "public"."orderitem"."fk_item_id" = "public"."item"."_id"
        INNER JOIN "public"."order" ON "public"."orderitem"."fk_order_id" = "public"."order"."_id"
        INNER JOIN "public"."user" ON "public"."order"."fk_user_id" = "public"."user"."_id"
        INNER JOIN "public"."itemgroup" ON "public"."item"."fk_group_id" = "public"."itemgroup"."_id"
        
        ORDER BY "public"."order"."_id"
        `;
